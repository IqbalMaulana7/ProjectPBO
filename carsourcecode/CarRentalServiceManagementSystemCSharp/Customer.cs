...
namespace CarRentalServiceManagementSystemCSharp
{
    public partial class Customer : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\Program Coding\Rent Car\carDatabase\carrental.mdf;Integrated Security=True");
            con.Open();
